...
![Hertz](https://img.shields.io/badge/Hertz-00ADD8?style=for-the-badge&logo=go&logoColor=white)
...
![Rocky%20Linux](https://img.shields.io/badge/Rocky_Linux-10B981?style=for-the-badge&logo=rockylinux&logoColor=white)
![Arch%20Linux](https://img.shields.io/badge/Arch%20Linux-1793D1?style=for-the-badge&logo=arch-linux&logoColor=white)
...
- **Web 开发**: 使用 TypeScript/Go 构建 RESTful APIs 和微服务
- **API 开发**: 使用 Python 和 Go 构建 API 工具
- **CLI 工具**: 用 Go 和 Python 开发命令行工具
- **容器化部署**: Docker 化应用
- **数据分析**: 使用 Python 进行统计分析和数据可视化
...
> ["旅途漫漫，千山万水，空白待绘，枯荣相随……"](https://blog.sheyiyuan.cn)
